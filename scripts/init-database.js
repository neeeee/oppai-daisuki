...
// Import models
const Video = require('../app/models/Video.ts').default;
const Photo = require('../app/models/Photo.ts').default;
const Gallery = require('../app/models/Gallery.ts').default;
const Idol = require('../app/models/Idol.ts').default;
const Genre = require('../app/models/Genre.ts').default;
const News = require('../app/models/News.ts').default;
...
async function createIndexes() {
  ...
  try {
    ...
    // Photo indexes
    await Photo.collection.createIndex({ title: 'text', description: 'text', tags: 'text' });
    ...
    // Gallery indexes
    await Gallery.collection.createIndex({ title: 'text', description: 'text', tags: 'text' });
    ...
    // Idol indexes
    await Idol.collection.createIndex({ name: 'text', stageName: 'text', bio: 'text' });
    ...
    // News indexes
    await News.collection.createIndex({ title: 'text', excerpt: 'text', content: 'text' });
  ...
  const articles = [
    {
      ...
      content: 'We are excited to launch Oppai Daisuki, a premium platform for gravure photography enthusiasts. Our mission is to showcase the beauty and artistry of Japanese gravure photography while supporting talented models and photographers.',
    ...
    },
    {
      ...
      excerpt: 'Featuring our latest verified models and their stunning portfolios.',
      content: 'This month we are highlighting some of our newest verified models who have joined our platform. Each brings their unique style and charm to the world of gravure photography.',
    ...
    },
    {
      ...
      excerpt: 'Learn professional gravure photography techniques from industry experts.',
      content: 'In this comprehensive guide, we share professional tips and techniques for gravure photography. From lighting setups to posing guidance, these insights will help photographers capture stunning images.',
...
async function getDatabaseStats() {
  ...
  try {
    const [videoCount, photoCount, galleryCount, idolCount, genreCount, newsCount] = await Promise.all([
    ...
    console.log(`   Total Documents: ${videoCount + photoCount + galleryCount + idolCount + genreCount + newsCount}`);
