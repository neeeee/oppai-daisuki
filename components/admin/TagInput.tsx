    ...
    <div className={`space-y-2 ${className}`}>
      ...
      >
        ...
        {tags.map((tag, index) => (
          <span
            key={index}
            className="inline-flex items-center gap-1 px-2 py-1 text-sm bg-indigo-100 text-indigo-800 rounded-md"
          >
            {tag}
            <button
              type="button"
              ...
              className="flex-shrink-0 ml-1 text-indigo-600 hover:text-indigo-800 focus:outline-none"
        ...
        <input
          ...
          className="flex-1 min-w-[120px] bg-transparent border-none outline-none placeholder-gray-400"
        />
      </div>
